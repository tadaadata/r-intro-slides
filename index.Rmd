...
- es wird komplizierter werden als $\bar{x} = \frac{1}{n} \sum_{i=1}^{n} {x_i}$ und $\sigma = \frac{1}{n}\sum_{i=1}^n \sqrt{({x_i} - \bar{x})^2}$
- SPSS kosttn viele viele Euros; niemand (erst recht nicht die Uni) möchte für schlechte Ware gutes Geld ausgeben
...
![](assets/images/install1.jpg)

## 

dann gleich den ersten Link:  
![](assets/images/install2.jpg)
