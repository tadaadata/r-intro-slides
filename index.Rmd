...
# Fürs nächste Mal: ANTIVIRUS DEAKTIVIEREN!!

## 

Das sorgt sonst dafür, dass sich R nicht ordentlich und Pakete gar nicht installieren lassen!
...
- [Übersicht](https://public.tadaa-data.de/data/readme.html)  
- [QM-Survey](https://public.tadaa-data.de/data/qm_survey_ss2017.rds)  
- [Game of Thrones](https://public.tadaa-data.de/data/gotdeaths_books.csv)  

<br />

Die Übungs-Scripte:  

- [Basics](https://public.tadaa-data.de/scripte/Basics.R)  
- [Tidyverse](https://public.tadaa-data.de/scripte/tidyverse.R)  
</div>
